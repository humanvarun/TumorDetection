...
% Last Modified by GUIDE v2.5 12-Nov-2024 14:19:08
...
axes(handles.axes1);
imshow(img1);
title('MRI Image', 'FontSize', 20, 'Color', [1, 0, 1]);
...
K = medfilt2(img1);
axes(handles.axes2);
imshow(K);title('Med Filter', 'FontSize', 20, 'Color', [1, 0, 1]);
...
axes(handles.axes3)
imshow(B);
title('Edge Detection', 'FontSize', 20, 'Color', [1, 0, 1]);
...
title('Tumor Detected !!!', 'FontSize', 20, 'Color', [1, 0, 1]);
